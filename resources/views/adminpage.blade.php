                ...
                <div id='table-sanpham' class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      <td>{{$user->foodid}}</td>
                      <td>{{$user ->foodname }}</td>
                      <td><span class="badge badge-success">{{$user->price}}</span></td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">{{$user->quantity}}</div>
                      </td>
                      <td> <button class="btn btn-icon waves-effect waves-light btn-danger m-b-5" type="button" class="btn btn-primary" data-toggle="modal" data-target="" onclick="XoaSanPham({{$user ->foodid}})" >
...
<script src="{{asset('assets/js/XoaSanPham.js')}}"></script>
