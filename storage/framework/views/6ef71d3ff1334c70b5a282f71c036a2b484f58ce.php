...
<head>
  ...
  <!-- Table style -->
  <link rel="stylesheets" href="<?php echo e(asset('/plugins/adminpage.css')); ?>">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="<?php echo e(asset('/assets/css/muahang.css')); ?>">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div id="idFood" style="display:none"><?php echo e($food->foodid); ?></div>
        ...
        <div class="row">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                      <div style="text-align:center;">
                          <img src="/<?php echo e($food -> img); ?>" alt=""><br><br>
                          <hr>
                        <div>
                        
                          <button  onclick="addToCart(<?php echo e($food->foodid); ?>)" type="button" class="btn btn-tinted btn--l YtgjXY_3a6p6c" aria-disabled="false"><i class="fa fa-shopping-cart"></i> Thêm Vào Giỏ Hàng
                          </button>
          ...
          <section class="col-lg-5 connectedSortable">
              <div class="card bg-white text-dark">
                <div class="card-body">
                        <h2> <?php echo e($food->foodname); ?></h2>
                          <hr>
                        <div class="gia" style="margin-top:10px;" >
                            <div id="price">Giá sản phẩm: <?php echo e($food->price); ?></div>
                            <div>Số lượng còn: <?php echo e($food->quantity); ?> sản phẩm </div>

                        </div>
                          
                            <hr>
                          <div>
                              <a onclick="increaseCartItem(<?php echo e($food->foodid); ?>)"  class="btn btn-success"  >Tăng</a>
                              <input type="text" value="1" id="check" style="width:50px;padding:3px 6px;"/>
                              <a onclick="decreaseItem(<?php echo e($food->foodid); ?>)" class="btn btn-success" >Giảm</a>
                            <!-- Số lượng <input onclick="increaseCartItem(<?php echo e($food->foodid); ?>)" type="number" name="soluong" id="sl" value="1" min="1" max="100"> -->
                          </div>
...
<script src="<?php echo e(asset('/dist/js/pages/dashboard2.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('/assets/js/foodDetail.js')); ?>"></script>

  <script src="<?php echo e(asset('/assets/js/oderpage.js')); ?>"></script>
...
<?php /**PATH D:\WEB\BANTHUCAN-20200524T020441Z-001\BANTHUCAN\resources\views/foodDetail.blade.php ENDPATH**/ ?>