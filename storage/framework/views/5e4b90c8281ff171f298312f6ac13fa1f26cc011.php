...
<head>
  ...
  <!-- Modal -->
  <link href="assets/css/modal.css" ref="stylesheet">
  <!-- Table style -->
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><?php echo e($user->orderid); ?></td>
                      <td><?php echo e($user->foodid); ?></td>
                      <td><span class="badge badge-success"><?php echo e($user->quantity); ?></span></td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo e($user->customerid); ?></div>
                      </td>
                      <td><?php echo e($user->name); ?></td>
                      <td>
                      <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#my"><i class="fa fa-times-circle"></i></button>
                      </i>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <tr>
          <th>ORDERID</th>
          <td><input type="text" name="idfood"></td>
...
<?php /**PATH E:\BANTHUCAN\resources\views/orderpage.blade.php ENDPATH**/ ?>