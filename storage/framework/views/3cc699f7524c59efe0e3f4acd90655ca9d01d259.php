...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="<?php echo e(('assets/css/animate-3.7.0.css')); ?>">
        ...
        <div class="container">
            ...
            <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img" >
                            <img src=<?php echo e($user-> img); ?>  class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5><?php echo e($user->foodname); ?></h5>
                                <span class="style-change"><?php echo e($user->price); ?></span>
                            </div>
                                <button><a href="/foodDetail/<?php echo e($user->foodid); ?>">Mua thức ăn</a></button>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
	...
	<script src="<?php echo e(asset('/assets/js/vendor/bootstrap-4.1.3.min.js')); ?>"></script>
...
<?php /**PATH D:\WEB\BANTHUCAN-20200524T020441Z-001\BANTHUCAN\resources\views/index.blade.php ENDPATH**/ ?>